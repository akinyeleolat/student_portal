...
export default class User {
  ...
  */
  ...
  create(values) {
    ...
    const sql = 'INSERT INTO users (firstname, lastname, email, telephone, password, image_url, user_status) VAlUES( ${firstname}, ${lastname}, ${email}, ${telephone}, ${password}, ${image}, ${userStatus}) RETURNING id, firstname, lastname, email, telephone, image_url, user_status';
